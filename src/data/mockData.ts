...
const seeds: Seed[] = [
  ...
  { id:'msg-29', brandId:'brand-1', customerId:'c16', ticketNumber:'#162160', platform:'instagram', channel:'Nike Europe', status:'answered', unread:false, starred:false, replyCount:2, newReplies:0, timestamp:'2026-06-23T09:00:00Z', tags:[{label:'profanity', color:'#dc2626'}], subject:'How do I redeem Nike member reward points?', preview:"I have 2,340 Nike member points but can't find where to redeem them in the app.", reply:"Hey Daan! Go to Nike app → Profile → Membership → Rewards. Points can be used at checkout on Nike.com too! 👟", customerMsg2:"Just redeemed for 20% off. Thanks! 🎉" },
  ...
  { id:'msg-72', brandId:'brand-3', customerId:'c20', ticketNumber:'#162116', platform:'facebook', channel:'Airbnb', status:'answered', unread:false, starred:false, replyCount:2, newReplies:0, timestamp:'2026-06-04T14:00:00Z', tags:[{label:'profanity', color:'#dc2626'}], subject:'Long-term stay discount for 28+ nights?', preview:"Considering a 4-week stay in Lisbon. Do longer bookings come with a discount?", reply:"James! Most hosts offer 20–50% monthly discount for 28+ nights — applied automatically at checkout. Filter by 'Monthly stay' to find listings with this enabled. 🌍", customerMsg2:"Just found a place for 35% off the weekly rate. Booking now!" },
  ...
  { id:'msg-81', brandId:'brand-3', customerId:'c24', ticketNumber:'#162107', platform:'twitter', channel:'Airbnb', status:'answered', unread:false, starred:false, replyCount:2, newReplies:0, timestamp:'2026-06-24T10:00:00Z', tags:[{label:'profanity', color:'#dc2626'}], subject:'What extra benefits do Superhost stays have?', preview:"What benefits do I get booking a Superhost listing compared to a regular one?", reply:"Hi Sarah! Superhost listings have hosts with 4.8+ ratings, <1h response time, and 10+ stays/year. More reliable check-ins and descriptions that match reality. Worth the filter! 🌟", customerMsg2:"Didn't know about that filter — using it from now on. Thanks!" },
  ...
  { id:'msg-116', brandId:'brand-2', customerId:'c30', ticketNumber:'#162072', platform:'twitter', channel:'Spotify', status:'answered', unread:false, starred:false, replyCount:2, newReplies:0, timestamp:'2026-05-18T09:00:00Z', tags:[{label:'profanity', color:'#dc2626'}], subject:'How does Spotify handle artist royalties?', preview:"I'm a musician and curious how Spotify pays artists. Is there a minimum threshold before payout?", reply:"Priya, great question! Artists are paid per stream based on their share of total streams. Payouts go to rights holders (labels/distributors) who then pay artists per their contracts. Direct artists using DistroKid etc. are paid monthly with no minimum threshold. 🎵", customerMsg2:"Thanks for the honest breakdown. Uploading my first single next month!" },
